...
const Game = {
    ...
    update() {
        ...
        // 总是尝试更新过渡效果，防止在状态切换后停止渲染
        if (this.transitionAlpha > 0 || this.state === 'transition') {
